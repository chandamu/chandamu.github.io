...
require(['ss', 'MiriyamUtil', 'MiriyamLib2'], function(ss, MiriyamUtil, MiriyamLib2) {
  ...
  Chandam$Core$Business.samples = function(identifier) {
    ...
    var s = '';
    var $enum1 = ss.enumerate(R.get_examples());
  ...
  MiriyamApp$Worker.onFeedback = function() {
    ...
    var TR3 = MiriyamApp$Worker._addTextAreaRow('fMessage');
  ...
  MiriyamApp$Worker._addTextAreaRow = function(Id) {
  ...
  MiriyamApp$Worker.onAppeal = function() {
    MiriyamApp$Worker._makeNotice('/v1/menu/notice_req.htm', 'nw2', '\u0c28\u0c3f\u0c35\u0c47\u0c26\u0c28', 0, 1, true);
  };
