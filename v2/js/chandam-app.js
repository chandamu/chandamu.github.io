  ...
  `}var E=class{static{this.ASSEMBLY=`Chandam.Wasm`}static async getAllRules(e=`te`){let t=await DotNet.invokeMethodAsync(this.ASSEMBLY,`GetAllRules`,e);return JSON.parse(t)}static async getAllRulesDetailed(e=`te`){let t=await DotNet.invokeMethodAsync(this.ASSEMBLY,`GetAllRulesDetailed`,e);return JSON.parse(t)}static async determine(e,t,n=`te`){let r=await DotNet.invokeMethodAsync(this.ASSEMBLY,`Determine`,e,t.yati,t.prasa,n,t.santiPrasa,t.soundexSandhi);return JSON.parse(r)}static async tryMatch(e,t,n){let r=await DotNet.invokeMethodAsync(this.ASSEMBLY,`TryMatch`,e,t,n.yati,n.prasa,n.santiPrasa,n.soundexSandhi);return JSON.parse(r)}static async getScores(e,t,n=50){let r=await DotNet.invokeMethodAsync(this.ASSEMBLY,`GetScores`,e,t.yati,t.prasa,n,t.santiPrasa,t.soundexSandhi);return JSON.parse(r)}static async getRuleInfo(e){let t=await DotNet.invokeMethodAsync(this.ASSEMBLY,`GetRuleInfo`,e);return JSON.parse(t)}static async getRuleDto(e){let t=await DotNet.invokeMethodAsync(this.ASSEMBLY,`GetRuleDto`,e);return JSON.parse(t)}static async getRandomPoem(e){let t=await DotNet.invokeMethodAsync(this.ASSEMBLY,`GetRandomPoem`,e);return JSON.parse(t)}static async getRandomPoemFromRuleSet(e=`te`){return await DotNet.invokeMethodAsync(this.ASSEMBLY,`GetRandomPoemFromRuleSet`,e)}static async reloadRules(e,t){let n=await DotNet.invokeMethodAsync(this.ASSEMBLY,`ReloadRules`,e,t);return JSON.parse(n)}static async searchRules(e,t=`te`){let n=await DotNet.invokeMethodAsync(this.ASSEMBLY,`SearchRules`,e.query||null,e.categories?.join(`,`)||null,e.chandamNames?.join(`,`)||null,e.frequencies?.join(`,`)||null,e.matraLengthMin||null,e.matraLengthMax||null,e.hasExamples,e.maxResults||0,t);return JSON.parse(n)}static async getVersion(){return await DotNet.invokeMethodAsync(this.ASSEMBLY,`GetVersion`)}static async getBuildDate(){return await DotNet.invokeMethodAsync(this.ASSEMBLY,`GetBuildDate`)}static async getAvailableFilters(e=`te`){let t=await DotNet.invokeMethodAsync(this.ASSEMBLY,`GetAvailableFilters`,e);return JSON.parse(t)}},me={Akkara:1,Divpada:2,Jati:3,Ragada:4,Ragada2:5,Shatpada:6,UpaJati:7,Sisamu:8,Vruttam:9,DaMDakamu:10,ArdhaVruttam:11,VishamaVruttam:12,GenricVruttam:99,Other:100},he={Akkara:`జాతి(అక్కరలు)`,Divpada:`జాతి(ద్విపదలు)`,Jati:`జాతి`,Ragada:`జాతి(రగడలు)`,Ragada2:`జాతి(రగడలు)`,Shatpada:`జాతి(షట్పదలు)`,UpaJati:`ఉపజాతి`,Sisamu:`ఉపజాతి(సీసములు)`,Vruttam:`వృత్తం`,DaMDakamu:`దండకము`,ArdhaVruttam:`అర్ధ సమవృత్తం`,VishamaVruttam:`విషమవృత్తం`,GenricVruttam:`ఏదేని సమ వృత్తం`,Other:`ఇతర`};function ge(e){let t=new Map;return e.forEach(e=>{if(e.padyamSubType===`GenricVruttam`)return;let n;n=e.padyamType===`Vruttam`&&e.padyamSubType===`Vruttam`&&e.chandamName?`vruttam:${e.chandamName}`:e.padyamSubType?`subtype:${e.padyamSubType}`:`subtype:Other`,t.has(n)||t.set(n,[]),t.get(n).push(e)}),t}function _e(e){return Array.from(e.keys()).sort((t,n)=>{let[r,i]=t.split(`:`),[a,o]=n.split(`:`);if(r===`subtype`&&i===`GenricVruttam`)return 1;if(a===`subtype`&&o===`GenricVruttam`)return-1;if(r===`vruttam`&&a===`vruttam`){let r=e.get(t),i=e.get(n);return(r[0]?.charLength??999)-(i[0]?.charLength??999)}return r===`subtype`&&a===`subtype`?(me[i]??100)-(me[o]??100):r===`subtype`?-1:a===`subtype`?1:0})}function ve(e){return he[e]||e}function ye(e,t){let[n,r]=e.split(`:`);if(n===`vruttam`){let n=t.get(e)?.[0]?.charLength;return n!==void 0&&n!==-1?`${r} (${n})`:r}return n===`subtype`&&he[r]||r}function be(e,t){let n=document.getElementById(t);if(!n)return;let r=ge(e),i=_e(r),a=document.createElement(`div`);a.className=`rule-list`;let o=null;i.forEach(e=>{let t=r.get(e),n=document.createElement(`div`);n.className=`rule-group-header`,n.textContent=ye(e,r),a.appendChild(n),t.forEach(e=>{o||={id:e.identifier,name:e.shortName||e.name};let t=document.createElement(`div`);t.className=`rule-item`,t.textContent=e.shortName||e.name,t.dataset.ruleId=e.identifier,t.dataset.ruleName=e.shortName||e.name,t.addEventListener(`click`,()=>{Ce(e.identifier,e.shortName||e.name)}),a.appendChild(t)})}),n.innerHTML=``,n.appendChild(a),xe(o),Se()}function xe(e){let t=document.getElementById(`rule-picker-inline`),n=document.getElementById(`selected-rule-name`);t&&e?(t.dataset.selectedRule=e.id,n&&(n.textContent=`${w(`editor_matching_with`)} ${e.name} ▼`)):t&&(t.dataset.selectedRule=``,n&&(n.textContent=`${w(`editor_matching_with`)} ${w(`editor_select_rule`)}`)),t&&(t.open=!1)}function Se(){let e=document.getElementById(`rule-picker-inline`);e&&document.addEventListener(`click`,t=>{e.open&&!e.contains(t.target)&&(e.open=!1)})}function Ce(e,t){we(e,t)}function we(e,t){let n=document.getElementById(`selected-rule-name`);n&&(n.textContent=`${w(`editor_matching_with`)} ${t} ▼`,n.classList.add(`has-selection`));let r=document.getElementById(`rule-picker-inline`);r&&(r.dataset.selectedRule=e,r.open=!1)}function Te(){return document.getElementById(`rule-picker-inline`)?.dataset.selectedRule||``}var Ee=class{constructor(){this.prefix=`chandam:`}set(e,t){try{localStorage.setItem(this.prefix+e,JSON.stringify(t))}catch(t){console.error(`Failed to save to localStorage: ${e}`,t)}}get(e,t){try{let n=localStorage.getItem(this.prefix+e);return n?JSON.parse(n):t}catch(n){return console.error(`Failed to read from localStorage: ${e}`,n),t}}remove(e){localStorage.removeItem(this.prefix+e)}clear(){Object.keys(localStorage).filter(e=>e.startsWith(this.prefix)).forEach(e=>localStorage.removeItem(e))}};async function De(e){let t=new TextEncoder,n=new Blob([t.encode(e)]).stream().pipeThrough(new CompressionStream(`gzip`)).getReader(),r=[],i=0;for(;;){let{done:e,value:t}=await n.read();if(e)break;r.push(t),i+=t.length}let a=new Uint8Array(i),o=0;for(let e of r)a.set(e,o),o+=e.length;return a}async function Oe(e){let t=new Blob([new Uint8Array(e)]).stream().pipeThrough(new DecompressionStream(`gzip`)).getReader(),n=[],r=0;for(;;){let{done:e,value:i}=await t.read();if(e)break;n.push(i),r+=i.length}let i=new Uint8Array(r),a=0;for(let e of n)i.set(e,a),a+=e.length;return new TextDecoder(`utf-8`).decode(i)}var ke=class{constructor(){this.dbName=x,this.version=1,this.db=null}async init(){if(!this.db)return new Promise((e,t)=>{let n=indexedDB.open(this.dbName,this.version);n.onerror=()=>t(n.error),n.onsuccess=()=>{this.db=n.result,e()},n.onupgradeneeded=e=>{let t=e.target.result;t.objectStoreNames.contains(`compressed-data`)||t.createObjectStore(`compressed-data`,{keyPath:`id`})}})}async destroyAndRecreate(){this.db&&=(this.db.close(),null),await new Promise((e,t)=>{let n=indexedDB.deleteDatabase(this.dbName);n.onsuccess=()=>e(),n.onerror=()=>t(n.error),n.onblocked=()=>e()}),await this.init()}async getData(e){this.db||await this.init();let t=await this.getRaw(e);if(!t)return;let n=await Oe(t.data);return JSON.parse(n)}async saveData(e,t){this.db||await this.init();let n={id:e,data:await De(JSON.stringify(t))};return new Promise((e,t)=>{let r=this.db.transaction(`compressed-data`,`readwrite`).objectStore(`compressed-data`).put(n);r.onsuccess=()=>e(),r.onerror=()=>t(r.error)})}async deleteData(e){return this.db||await this.init(),new Promise((t,n)=>{let r=this.db.transaction(`compressed-data`,`readwrite`).objectStore(`compressed-data`).delete(e);r.onsuccess=()=>t(),r.onerror=()=>n(r.error)})}async clearAll(){return this.db||await this.init(),new Promise((e,t)=>{let n=this.db.transaction(`compressed-data`,`readwrite`).objectStore(`compressed-data`).clear();n.onsuccess=()=>e(),n.onerror=()=>t(n.error)})}async getRaw(e){return new Promise((t,n)=>{let r=this.db.transaction(`compressed-data`,`readonly`).objectStore(`compressed-data`).get(e);r.onsuccess=()=>t(r.result),r.onerror=()=>n(r.error)})}},Ae=S.STORAGE_VERSION,je=[{version:`A`,name:`compressed-storage`,migrate:Pe}];async function Me(){let e=localStorage.getItem(Ae)??``;for(let t of je)e<t.version&&(console.log(`Migration: ${t.name} → ${t.version}`),await t.migrate(),localStorage.setItem(Ae,t.version))}function Ne(){localStorage.removeItem(Ae)}async function Pe(){await Fe()}async function Fe(){return new Promise((e,t)=>{let n=indexedDB.deleteDatabase(x);n.onsuccess=()=>e(),n.onerror=()=>t(n.error),n.onblocked=()=>{console.warn(`Migration: DB delete blocked — closing open connections`),e()}})}var D=new class{constructor(){this.localStorage=new Ee,this.indexedDB=new ke,this.initialized=!1}async init(){this.initialized||=(await Me(),await this.indexedDB.init(),!0)}saveEditorState(e){e.text!==void 0&&this.localStorage.set(`editor:text`,e.text),e.language!==void 0&&this.localStorage.set(`editor:language`,e.language),e.matchYati!==void 0&&this.localStorage.set(`editor:matchYati`,e.matchYati),e.matchPrasa!==void 0&&this.localStorage.set(`editor:matchPrasa`,e.matchPrasa),e.selectedRule!==void 0&&this.localStorage.set(`editor:selectedRule`,e.selectedRule)}loadEditorState(){return{text:this.localStorage.get(`editor:text`,``)||``,language:this.localStorage.get(`editor:language`,`te`)||`te`,matchYati:this.localStorage.get(`editor:matchYati`,!0)??!0,matchPrasa:this.localStorage.get(`editor:matchPrasa`,!0)??!0,selectedRule:this.localStorage.get(`editor:selectedRule`,``)}}clearEditorState(){this.localStorage.remove(`editor:text`),this.localStorage.remove(`editor:selectedRule`)}saveUIState(e){e.ruleSet!==void 0&&this.localStorage.set(`ui:ruleSet`,e.ruleSet),e.autoDetect!==void 0&&this.localStorage.set(`ui:autoDetect`,e.autoDetect),e.lastVisited!==void 0&&this.localStorage.set(`ui:lastVisited`,e.lastVisited)}loadUIState(){return{ruleSet:this.localStorage.get(`ui:ruleSet`,`frequent`)||`frequent`,autoDetect:this.localStorage.get(`ui:autoDetect`,!0)??!0,lastVisited:this.localStorage.get(`ui:lastVisited`)}}async clearAll(){this.localStorage.clear(),Ne(),await this.init(),await this.indexedDB.clearAll()}},Ie;function Le(){return document.getElementById(`poem-editor`)?.value||``}function Re(e){let t=document.getElementById(`poem-editor`);t&&(t.value=e)}function ze(){Re(``),D.clearEditorState()}function Be(){let e=document.getElementById(`poem-editor`);if(!e){console.warn(`Cannot enable auto-save: editor element not found`);return}e.removeEventListener(`input`,Ve),e.addEventListener(`input`,Ve),console.log(`Editor auto-save enabled (1s debounce)`)}function Ve(e){let t=e.target;Ie!==void 0&&window.clearTimeout(Ie),Ie=window.setTimeout(()=>{D.saveEditorState({text:t.value}),console.log(`Editor text auto-saved to localStorage`)},1e3)}function He(e,t){return document.getElementById(e)?.checked??t}function Ue(){return{yati:He(`match-yati`,!0),prasa:He(`match-prasa`,!0),santiPrasa:He(`match-santi-prasa`,!1),soundexSandhi:He(`match-soundex-sandhi`,!1)}}function We(e){return`
    <div class="editor-section">
      ...
      <details class="advanced-options" id="advanced-options">
        <summary>${w(`editor_advanced`)}</summary>
...
`)}function et(e,t){let n=new URL(`${ee}/issues/new`);e.type===`custom-rule`?(n.searchParams.set(`template`,`custom-rule-submission.md`),n.searchParams.set(`title`,`[Custom Rule] ${e.ruleName}`),n.searchParams.set(`labels`,`custom-rule,community`)):(n.searchParams.set(`template`,`new-examples.md`),n.searchParams.set(`title`,`[New Example] ${e.ruleName} (${e.ruleSetId}/${e.ruleIdentifier})`),n.searchParams.set(`labels`,`examples,community`)),n.searchParams.set(`body`,$e(e,t)),window.open(n.toString(),`_blank`,`noopener,noreferrer`)}function tt(e,t,n,r,i,a){return{type:`custom-rule`,ruleName:e,ruleIdentifier:t,language:n,description:r,rule:i,examples:a,exportedAt:new Date().toISOString(),version:`1.0`}}function nt(e,t,n,r){return{type:`new-example`,ruleName:e,ruleSetId:t,ruleIdentifier:n,examples:r,exportedAt:new Date().toISOString(),version:`1.0`}}function rt(e){let t=document.createElement(`div`);return t.innerHTML=e,t.textContent||``}var it=S.POEMS,O=new class{async addPoem(e,t,n,r,i){await D.init();let a=await this.loadPoems();if(a.length>=20)return`full`;let o=await Ye(t,r);return a.some(e=>e.poemHash===o)?`duplicate`:(a.push({ruleSetId:e,ruleIdentifier:t,ruleName:n,poemText:r,beautified:i,poemHash:o,addedAt:Date.now()}),await this.savePoems(a),`added`)}async removePoem(e){await D.init();let t=(await this.loadPoems()).filter(t=>t.poemHash!==e);await this.savePoems(t)}async getAllPoems(){return await D.init(),this.loadPoems()}async isInCollection(e,t){await D.init();let n=await Ye(e,t);return(await this.loadPoems()).some(e=>e.poemHash===n)}async getPoemCount(){return(await this.loadPoems()).length}async loadPoems(){return await D.indexedDB.getData(it)??[]}async savePoems(e){await D.indexedDB.saveData(it,e)}};function at(e){return e.split(/<br\s*\/?>/gi).filter(e=>e.trim()).map(e=>`<span class="poem-line">${e}</span>`).join(``)}var ot=new Map;async function st(e,t,n,r){let i=document.getElementById(t);if(!i)return;i.innerHTML=ct(e,n,r?.showRuleLink??!0)+yt(),ft(i,n);let a=document.getElementById(`results-section`);a&&(a.style.display=`block`),await bt(e)}function ct(e,t,n=!0){ot.set(e.rule.identifier,e);let r=e.isMatched?`match-success`:`match-failure`,i=e.isMatched?`✓`:`✗`,a=lt(e.matchPercentage),o=e.matchPercentage<100?`<div class="match-score-group">
  ...
  `}function vt(){let e=document.getElementById(`results-section`);e&&(e.style.display=`none`);let t=document.getElementById(`results-container`);t&&(t.innerHTML=``);let n=document.getElementById(`score-cards-container`);n&&(n.innerHTML=``)}function yt(){return`<div class="results-disclaimer">${w(`results_disclaimer`)}</div>`}function k(e){return e.replace(/&/g,`&amp;`).replace(/"/g,`&quot;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}async function bt(e){if(t.trackEvent(`analysis_result`,{ruleId:e.rule.identifier,matchPercentage:e.matchPercentage,score:e.score,total:e.total}),e.matchPercentage===100)try{let n=document.getElementById(`poem-editor`)?.value||``;if(n){let r=await Ye(e.rule.identifier,n);t.trackEvent(`perfect_match`,{ruleId:e.rule.identifier,contentHash:r})}}catch(e){console.error(`Failed to track perfect match:`,e)}}function A(e){let{ruleSetId:t,ruleId:n,currentMode:r}=e,i=n?`/learn/${t}/${n}`:`/learn/${t}/`,a=n?`/compute/${t}/${n}`:`/compute/${t}/`,o=r===`learn`,s=r===`compute`,c=`mode-tab mode-tab-learn${o?` mode-tab-active`:``}`,l=`mode-tab mode-tab-compute${s?` mode-tab-active`:``}`,u=o?`<span class="${c}">${xt(w(`mode_learn`))}</span>`:`<a href="${v(i)}" class="${c}">${xt(w(`mode_learn`))}</a>`,d=s?`<span class="${l}">${xt(w(`mode_compute`))}</span>`:`<a href="${v(a)}" class="${l}">${xt(w(`mode_compute`))}</a>`;return`
    <nav class="mode-switcher" role="tablist" aria-label="${w(`mode_switcher_aria_label`)}">
      ${u}
      ${d}
    </nav>
  `}function xt(e){let t=document.createElement(`div`);return t.textContent=e,t.innerHTML}var St=S.FAVORITES;S.FAV_RULESET;var j=new class{async isFavorited(e,t){let n=this.makeCompositeId(e,t);return(await this.loadFavorites()).some(e=>e.id===n)}async toggleFavorite(e,t,n){await D.init();let r=this.makeCompositeId(e,t),i=await this.loadFavorites(),a=i.findIndex(e=>e.id===r);if(a>=0)i.splice(a,1);else{if(i.length>=50)throw Error(`Maximum 50 favorites reached`);i.push({id:r,ruleSetId:e,ruleId:t,ruleData:n,favoritedAt:Date.now()})}return await this.saveFavorites(i),await this.regenerateFavoritesRuleset(i),a<0}async regenerateFavoritesRuleset(e){await D.init();let t=e??await this.loadFavorites();t.sort((e,t)=>e.favoritedAt-t.favoritedAt);let n=await this.loadCustomRulesets();if(t.length>0){let e={id:`custom-fav`,name:`⭐ My Favorites`,description:`${t.length} favorited rules from various rulesets`,rules:t.map(e=>e.ruleData),type:`favorites`,createdAt:Date.now(),updatedAt:Date.now()},r=n.findIndex(e=>e.id===`custom-fav`);r>=0?n[r]=e:n.push(e)}else{let e=n.findIndex(e=>e.id===`custom-fav`);e>=0&&n.splice(e,1)}await D.indexedDB.saveData(`custom-rulesets`,n)}async getFavoriteCount(){return(await this.loadFavorites()).length}async getAllFavorites(){return this.loadFavorites()}makeCompositeId(e,t){return`${e}:${t}`}async loadFavorites(){return await D.init(),await D.indexedDB.getData(St)??[]}async saveFavorites(e){await D.indexedDB.saveData(St,e)}async loadCustomRulesets(){return await D.indexedDB.getData(`custom-rulesets`)??[]}},Ct=`toast-container`,wt=3,Tt=5e3,Et=0,M=[];function Dt(){let e=document.getElementById(Ct);return e||(e=document.createElement(`div`),e.id=Ct,e.className=`toast-container`,e.setAttribute(`aria-live`,`assertive`),e.setAttribute(`aria-atomic`,`true`),document.body.appendChild(e)),e}function Ot(e){let t=M.findIndex(t=>t.id===e.id);t>=0&&M.splice(t,1),window.clearTimeout(e.dismissTimeout),e.element.classList.add(`is-closing`),window.setTimeout(()=>{e.element.remove()},240)}function kt(e,t){let n,r=window.setTimeout(()=>{Ot(n)},t);return n={id:++Et,element:e,dismissTimeout:r},M.push(n),n}function At(){for(;M.length>wt;){let e=M.shift();if(!e)break;window.clearTimeout(e.dismissTimeout),e.element.remove()}}function jt(e,t,n){let r=document.createElement(`article`);r.className=`toast toast-${e}`,r.setAttribute(`role`,`alert`);let i=n.durationMs??Tt,a=document.createElement(`h4`);a.className=`toast-title`,a.textContent=n.title??e.charAt(0).toUpperCase()+e.slice(1);let o=document.createElement(`p`);o.className=`toast-message`,o.textContent=t;let s=document.createElement(`button`);s.type=`button`,s.className=`toast-close`,s.setAttribute(`aria-label`,`Dismiss notification`),s.textContent=`x`;let c=document.createElement(`div`);c.className=`toast-progress`,c.style.animationDuration=`${i}ms`;let l=document.createElement(`div`);return l.className=`toast-content`,l.appendChild(a),l.appendChild(o),r.appendChild(l),r.appendChild(s),r.appendChild(c),r}function N(e,t=`info`,n={}){let r=Dt(),i=jt(t,e,n);r.appendChild(i);let a=kt(i,n.durationMs??Tt);i.querySelector(`.toast-close`)?.addEventListener(`click`,()=>Ot(a)),At()}function Mt(e,t=`warning`,n={}){let r=e.filter(Boolean);if(r.length===0)return;let i=Dt(),a=document.createElement(`article`);a.className=`toast toast-${t}`,a.setAttribute(`role`,`alert`);let o=n.durationMs??Tt,s=document.createElement(`h4`);s.className=`toast-title`,s.textContent=n.title??`Validation`;let c=document.createElement(`ul`);c.className=`toast-list`,r.forEach(e=>{let t=document.createElement(`li`);t.textContent=e,c.appendChild(t)});let l=document.createElement(`button`);l.type=`button`,l.className=`toast-close`,l.setAttribute(`aria-label`,`Dismiss notification`),l.textContent=`x`;let u=document.createElement(`div`);u.className=`toast-progress`,u.style.animationDuration=`${o}ms`;let d=document.createElement(`div`);d.className=`toast-content`,d.appendChild(s),d.appendChild(c),a.appendChild(d),a.appendChild(l),a.appendChild(u),i.appendChild(a);let f=kt(a,o);l.addEventListener(`click`,()=>Ot(f)),At()}var Nt=`confirm-dialog-overlay`;function Pt(e){e.classList.add(`is-closing`),window.setTimeout(()=>{e.remove()},150)}function Ft(e,t,n){if(e.key!==`Tab`)return;let r=document.activeElement;e.shiftKey&&r===t?(e.preventDefault(),n.focus()):!e.shiftKey&&r===n&&(e.preventDefault(),t.focus())}function It(e,t={}){let n=document.getElementById(Nt);return n&&n.remove(),new Promise(n=>{let r=document.activeElement,i=document.createElement(`div`);i.id=Nt,i.className=`confirm-overlay`;let a=document.createElement(`div`);a.className=`confirm-dialog`,a.setAttribute(`role`,`dialog`),a.setAttribute(`aria-modal`,`true`);let o=document.createElement(`h3`);o.className=`confirm-title`,o.textContent=t.title??`Confirm action`;let s=document.createElement(`p`);s.className=`confirm-message`,s.textContent=e;let c=document.createElement(`div`);c.className=`confirm-actions`;let l=document.createElement(`button`);l.type=`button`,l.className=`btn-secondary`,l.textContent=t.cancelText??`Cancel`;let u=document.createElement(`button`);u.type=`button`,u.className=`btn-danger`,u.textContent=t.confirmText??`Delete`,c.appendChild(l),c.appendChild(u),a.appendChild(o),a.appendChild(s),a.appendChild(c),i.appendChild(a),document.body.appendChild(i);let d=l,f=u,p=e=>{document.removeEventListener(`keydown`,m),Pt(i),r?.focus(),n(e)},m=e=>{if(e.key===`Escape`){p(!1);return}Ft(e,d,f)};document.addEventListener(`keydown`,m),i.addEventListener(`click`,e=>{e.target===i&&p(!1)}),l.addEventListener(`click`,()=>p(!1)),u.addEventListener(`click`,()=>p(!0)),l.focus()})}async function Lt(e,t,n){let r=document.getElementById(e);if(!r)return;if(await D.init(),!n){r.innerHTML=`
      <div class="rule-actions">
        ${Vt()}
      </div>
    `;return}let i=t===`custom-rules`||t===`custom-fav`,a=!1;i||(a=await j.isFavorited(t,n)),r.innerHTML=`
    <div class="rule-actions">
      ${i?``:Rt(a,t,n)}
      ${Bt(t,n)}
      ${zt(t,n)}
    </div>
  `,i||Ut(t,n),Ht(t,n),Wt(t,n)}function Rt(e,t,n){return`
  ...
  `:``}function Bt(e,t){return t.startsWith(`custom-`)?`
  ...
  `}function Ht(e,n){let r=document.getElementById(`btn-github-submit`);r&&r.addEventListener(`click`,async()=>{let r=t.startTimedEvent(`submit_github_click`,{ruleId:n,ruleSetId:e,source:`rule_actions_toolbar`});Xe(nt((await E.getRuleInfo(n)).name,e,n,[]),`rule_actions`),r()})}function Ut(e,t){let n=document.getElementById(`btn-favorite`);n&&n.addEventListener(`click`,()=>Gt(e,t))}function Wt(e,t){let n=document.getElementById(`btn-delete`);n&&n.addEventListener(`click`,async()=>await Kt(e,t))}async function Gt(e,n){let r=document.getElementById(`btn-favorite`);if(!r)return;let i=t.startTimedEvent(`favorite_toggle`,{ruleSet:e,ruleId:n});try{r.classList.add(`favoriting`);let t=await E.getRuleDto(n),a=await j.toggleFavorite(e,n,t),o=await j.getFavoriteCount();i({action:a?`add`:`remove`,totalFavorites:o}),r.setAttribute(`data-favorited`,String(a)),r.setAttribute(`title`,w(a?`action_remove_favorite`:`action_add_favorite`)),r.setAttribute(`aria-label`,w(a?`action_remove_favorite`:`action_add_favorite`)),setTimeout(()=>r.classList.remove(`favoriting`),300)}catch(e){console.error(`Failed to toggle favorite:`,e),e instanceof Error&&e.message.includes(`Maximum 50 favorites`)?(t.startTimedEvent(`favorites_limit_reached`,{ruleId:n})(),N(w(`alert_max_favorites`),`warning`)):N(w(`alert_favorite_failed`),`error`),r.classList.remove(`favoriting`)}}async function Kt(e,n){if(!await It(w(`alert_delete_confirm`),{title:w(`action_delete_custom_rule`),cancelText:w(`creator_btn_cancel`),confirmText:w(`action_delete_custom_rule`)}))return;let r=t.startTimedEvent(`custom_rule_deleted`,{ruleId:n,source:`detail_page`,viewedFrom:e});try{let{customRulesService:t}=await d(async()=>{let{customRulesService:e}=await Promise.resolve().then(()=>qt);return{customRulesService:e}},void 0);await t.deleteCustomRule(n);let i=`custom-rules`;if(await j.isFavorited(i,n)){let e=await E.getRuleDto(n);await j.toggleFavorite(i,n,e)}r();let{makeUrl:a}=await d(async()=>{let{makeUrl:e}=await Promise.resolve().then(()=>h);return{makeUrl:e}},void 0);e===`custom-fav`?window.location.href=a(`/learn/custom-fav/`):window.location.href=a(`/learn/custom-rules/`)}catch(e){console.error(`Failed to delete rule:`,e),N(w(`alert_delete_failed`),`error`)}}var qt=e({CustomRulesService:()=>Xt,customRulesService:()=>P}),Jt=S.CUSTOM_RULESETS,Yt=S.CUSTOM_RULES_ID,Xt=class{async createCustomRule(e){await D.init();let t=await this.loadRulesets(),n=t.find(e=>e.id===Yt);if(n||(n={id:Yt,name:`Custom Rules`,description:`0 custom rules created`,rules:[],type:`custom`,createdAt:Date.now(),updatedAt:Date.now()},t.push(n)),n.rules.length>=50)throw Error(`Maximum 50 custom rules reached`);n.rules.push(e),n.updatedAt=Date.now(),n.description=`${n.rules.length} custom ${n.rules.length===1?`rule`:`rules`} created`,await this.saveRulesets(t)}async getAllCustomRules(){await D.init();let e=await this.getCustomRulesCollection();return e?e.rules:[]}async getCustomRulesCount(){let e=await this.getCustomRulesCollection();return e?e.rules.length:0}async deleteCustomRule(e){await D.init();let t=await this.loadRulesets(),n=t.find(e=>e.id===Yt);if(n){if(n.rules=n.rules.filter(t=>t.Identifier!==e),n.updatedAt=Date.now(),n.description=`${n.rules.length} custom ${n.rules.length===1?`rule`:`rules`} created`,n.rules.length===0){let e=t.indexOf(n);t.splice(e,1)}await this.saveRulesets(t)}}async getCustomRulesCollection(){return await D.init(),(await this.loadRulesets()).find(e=>e.id===Yt)??null}async getCustomRuleset(e){return await D.init(),(await this.loadRulesets()).find(t=>t.id===e)??null}async getAllCustomRulesets(){return await D.init(),this.loadRulesets()}async addExampleToRule(e,t){await D.init();let n=await this.loadRulesets(),r=n.find(e=>e.id===Yt);if(!r)return!1;let i=r.rules.find(t=>t.Identifier===e);if(!i)return!1;let a=t.trim().replace(/\s+/g,` `);return i.Examples.some(e=>e.trim().replace(/\s+/g,` `)===a)?!1:(i.Examples.push(t.trim()),r.updatedAt=Date.now(),await this.saveRulesets(n),!0)}async getCustomRule(e){return(await this.getAllCustomRules()).find(t=>t.Identifier===e)??null}async ruleExists(e){return(await this.getAllCustomRules()).some(t=>t.Identifier===e)}async loadRulesets(){return await D.indexedDB.getData(Jt)??[]}async saveRulesets(e){await D.indexedDB.saveData(Jt,e)}},P=new Xt,F=class{static{this._loadedRulesetId=null}static{this._loadedRulesetHash=0}static async loadCustomRuleset(e,t=!1){try{let n=await P.getCustomRuleset(e);if(!n||!n.rules||n.rules.length===0)return console.log(`No custom ruleset found with ID: ${e}`),!1;let r=n.rules.length*31+(n.updatedAt??0);if(!t&&this._loadedRulesetId===e&&this._loadedRulesetHash===r)return!0;let i=await this.loadRulesetIntoWasm(n);return i&&(this._loadedRulesetId=e,this._loadedRulesetHash=r),i}catch(t){return console.error(`Error loading custom ruleset ${e}:`,t),!1}}static invalidateCache(){this._loadedRulesetId=null,this._loadedRulesetHash=0}static async loadFavoritesCollection(){return await this.loadCustomRuleset(`custom-fav`)}static async hasCustomRuleset(e){let t=await P.getCustomRuleset(e);return t!==null&&t.rules.length>0}static async loadRulesetIntoWasm(e){try{let t=JSON.stringify({Identifier:e.id,Name:e.name,Description:e.description,Rules:e.rules}),n=await DotNet.invokeMethodAsync(`Chandam.Wasm`,`LoadCustomRules`,t),r=JSON.parse(n);return r.success?(Qt(),console.log(`Loaded ${r.ruleCount} rules from custom ruleset "${e.name}"`),!0):(console.error(`Failed to load custom rules:`,r.errorMessage),!1)}catch(e){return console.error(`Error loading rules into WASM:`,e),!1}}},Zt=null;function Qt(){Zt=null}async function $t(e,t){if(e!==Zt)try{F.invalidateCache();let n=await E.reloadRules(e,t);n.success?Zt=e:console.error(`Failed to load rules:`,n.errorMessage)}catch(e){console.error(`Failed to load rule set:`,e)}}var I=function(e){return e.LoadingStarted=`loading:started`,e.LoadingCompleted=`loading:completed`,e.LoadingFailed=`loading:failed`,e.ActionStarted=`action:started`,e.ActionCompleted=`action:completed`,e.ActionFailed=`action:failed`,e}({}),L=class{static emit(e,t){let n=new CustomEvent(e,{detail:t});window.dispatchEvent(n)}static onLoadingStarted(e){window.addEventListener(I.LoadingStarted,t=>{e(t.detail)})}static onLoadingCompleted(e){window.addEventListener(I.LoadingCompleted,t=>{e(t.detail)})}static onLoadingFailed(e){window.addEventListener(I.LoadingFailed,t=>{e(t.detail)})}static onActionStarted(e){window.addEventListener(I.ActionStarted,t=>{e(t.detail)})}static onActionCompleted(e){window.addEventListener(I.ActionCompleted,t=>{e(t.detail)})}static onActionFailed(e){window.addEventListener(I.ActionFailed,t=>{e(t.detail)})}};function en(){return new Promise(e=>requestAnimationFrame(()=>setTimeout(e,0)))}var R=null,tn=[],z=``;async function nn(e){R=null,z=e;let t=document.getElementById(`content`);t&&(t.innerHTML=`<div class="page-loading">
    ...
    </div>`);let n=await m(e);if(!n){console.error(`Rule set not found: ${e}`);return}if(s(`Compute `+n.name),n.rulesFile)await $t(n.rulesFile,n.examplesFile);else if(!await F.loadCustomRuleset(e)){console.error(`Failed to load custom ruleset: ${e}`);return}let r=(await E.getAllRulesDetailed()).filter(e=>e.padyamSubType!==`GenricVruttam`);tn=r,rn(n.name,r.length,e);let i=D.loadEditorState();if(i.text){let e=document.getElementById(`poem-editor`);e&&(e.value=i.text,console.log(`Restored editor text from previous session`))}Be(),be(r,`rule-picker-container`),an(e)}function rn(e,t,n){let r=document.getElementById(`content`);r&&(r.innerHTML=`
    <div class="compute-rule-set-page">
      ...
      <div class="page-header-controls">
        ...
        ${A({ruleSetId:n,currentMode:`compute`})}
      </div>
      <div class="page-subtitle">${t} ${w(`label_rules_count`)}</div>

      ${We({contextText:w(`editor_auto_detect_context`),showRulePicker:!0,showAutoDetect:!0})}
  ...
  `,Lt(`rule-actions-container`,n))}function an(e){Ge(),document.getElementById(`auto-detect`)?.addEventListener(`change`,e=>{e.target.checked?qe():(Ke(),R&&we(R.id,R.name))}),document.getElementById(`btn-analyze`)?.addEventListener(`click`,async()=>{let e=document.getElementById(`auto-detect`)?.checked,n=t.startTimedEvent(`analyze_click`,{mode:e?`auto_detect`:`specific_rule`,ruleSet:z,ruleId:e?null:Te(),autoDetect:e});e?await on():await sn(),n()}),document.getElementById(`btn-random`)?.addEventListener(`click`,async()=>{let e=t.startTimedEvent(`random_click`,{ruleSet:z,ruleId:`auto_detect`});L.emit(I.ActionStarted,{source:`random`,buttonId:`btn-random`}),await en();try{let e=await E.getRandomPoemFromRuleSet();if(e){let t=document.getElementById(`poem-editor`);t&&(t.value=e)}else N(w(`alert_no_examples`),`warning`)}catch(e){console.error(`Random poem failed:`,e)}finally{L.emit(I.ActionCompleted,{source:`random`,buttonId:`btn-random`})}e()}),document.getElementById(`btn-clear`)?.addEventListener(`click`,()=>{let e=document.getElementById(`poem-editor`),n=e?e.value.length>0:!1,r=t.startTimedEvent(`clear_click`,{ruleSet:z,hadContent:n});ze(),vt(),r()}),document.getElementById(`score-cards-container`)?.addEventListener(`click`,e=>{let n=e.target.closest(`.score-card-try`);if(!n)return;let r=n.getAttribute(`data-rule-id`),i=n.getAttribute(`data-rule-name`);if(!r||!i)return;t.startTimedEvent(`score_card_try`,{ruleSet:z,ruleId:r})();let a=document.getElementById(`auto-detect`);a&&a.checked&&(a.checked=!1,Ke()),we(r,i),document.getElementById(`btn-analyze`)?.click()})}async function on(){let e=document.getElementById(`score-cards-container`);e&&(e.innerHTML=``);let t=Le();if(!t.trim()){N(w(`alert_enter_poem`),`warning`);return}let n=Ue();L.emit(I.ActionStarted,{source:`analyze`,buttonId:`btn-analyze`,resultContainerId:`results-section`}),await en();try{let[r,i]=await Promise.all([E.determine(t,n),E.getScores(t,n,50).catch(()=>null)]);if(r.success&&r.matches.length>0){let t=r.matches[0];R={id:t.rule.identifier,name:t.rule.shortName||t.rule.name},await st(t,`results-container`,z);let n=document.getElementById(`results-section`);if(n&&(n.style.display=`block`),i?.scores&&i.scores.length>1&&e){let n=i.scores.filter(e=>e.identifier!==t.rule.identifier).slice(0,5);n.length>0?_t(n,`score-cards-container`,z):e.innerHTML=``}else e&&(e.innerHTML=``);await en()}else N(r.errorMessage||w(`alert_no_matches`),`error`)}catch(e){console.error(`Determine failed:`,e),N(w(`alert_error`),`error`)}finally{L.emit(I.ActionCompleted,{source:`analyze`,buttonId:`btn-analyze`,resultContainerId:`results-section`})}}async function sn(){let e=document.getElementById(`score-cards-container`);e&&(e.innerHTML=``);let t=Le(),n=Te();if(!t.trim()){N(w(`alert_enter_poem`),`warning`);return}if(!n){N(w(`alert_select_rule`),`warning`);let e=document.getElementById(`rule-picker-inline`);e&&(e.classList.add(`error`),setTimeout(()=>e.classList.remove(`error`),2e3));return}let r=tn.find(e=>e.identifier===n);r&&(R={id:r.identifier,name:r.shortName||r.name}),L.emit(I.ActionStarted,{source:`match`,buttonId:`btn-analyze`,resultContainerId:`results-section`}),await en();try{let e=await E.tryMatch(t,n,Ue());if(e.isMatch&&e.match){await st(e.match,`results-container`,z);let t=document.getElementById(`results-section`);t&&(t.style.display=`block`),await en()}else N(e.errorMessage||w(`alert_no_match`),`error`)}catch(e){console.error(`Match failed:`,e),N(w(`alert_error`),`error`)}finally{L.emit(I.ActionCompleted,{source:`match`,buttonId:`btn-analyze`,resultContainerId:`results-section`})}}async function cn(e){let t=e.ruleSet,n=e.ruleId,r=await m(t);if(!r){console.error(`Rule set not found: ${t}`);return}if(r.rulesFile)await $t(r.rulesFile,r.examplesFile);else if(!await F.loadCustomRuleset(t)){console.error(`Failed to load custom ruleset: ${t}`);return}let i=await E.getRuleInfo(n);s(`Compute `+i.name,r.name);let a=await ln(e);await pn(t,i.name,n,a,r.name),mn(t,n)}async function ln(e){let t=e.ruleSet,n=e.ruleId,r=un(e);if(r!==null){let e=await dn(n,r);return e===null?(fn(t,n),``):e}else return(await E.getRandomPoem(n)).text}function un(e){if(!e.example)return null;let t=parseInt(e.example,10);return isNaN(t)||t<1?null:t}async function dn(e,t){let n=await E.getRuleInfo(e);if(!n.examples||n.examples.length===0)return null;let r=t-1;return r<0||r>=n.examples.length?null:n.examples[r].text}function fn(e,t){let n=v(`/compute/${e}/${t}`);window.history.replaceState(null,``,n)}async function pn(e,t,n,r,i){let a=document.getElementById(`content`);if(!a)return;a.innerHTML=`
    <div class="compute-rule-page">
      ...
      <div class="page-header-controls">
        ...
        <div id="rule-actions-container"></div>
        ${A({ruleSetId:e,ruleId:n,currentMode:`compute`})}
      </div>

      ${We({contextText:`${w(`editor_matching_with`)} ${t}`,showRulePicker:!1,showAutoDetect:!1})}
  ...
  `,await Lt(`rule-actions-container`,e,n);let o=document.getElementById(`poem-editor`);if(o)if(r)o.value=r;else{let e=D.loadEditorState();e.text&&(o.value=e.text,console.log(`Restored editor text from previous session`))}Be()}function mn(e,n){Ge(),document.getElementById(`btn-analyze`)?.addEventListener(`click`,async()=>{let r=document.getElementById(`poem-editor`)?.value||``;if(!r.trim()){N(w(`alert_enter_poem`),`warning`);return}let i=t.startTimedEvent(`analyze_click`,{mode:`specific_rule`,ruleSet:e,ruleId:n,autoDetect:!1});try{let t=await E.tryMatch(r,n,Ue());if(t.isMatch&&t.match){st(t.match,`results-container`,e,{showRuleLink:!1});let n=document.getElementById(`results-section`);n&&(n.style.display=`block`)}else N(t.errorMessage||w(`alert_no_match`),`error`)}catch(e){console.error(`Match failed:`,e),N(w(`alert_error`),`error`)}i()}),document.getElementById(`btn-random`)?.addEventListener(`click`,async()=>{let r=t.startTimedEvent(`random_click`,{ruleSet:e,ruleId:n});try{let e=await E.getRandomPoem(n);if(e.text){let t=document.getElementById(`poem-editor`);t&&(t.value=e.text),e.isGenerated&&N(w(`alert_generated_poem`),`info`)}else N(w(`alert_no_examples`),`warning`)}catch(e){console.error(`Random poem failed:`,e)}r()}),document.getElementById(`btn-clear`)?.addEventListener(`click`,()=>{let n=document.getElementById(`poem-editor`),r=n?n.value.length>0:!1,i=t.startTimedEvent(`clear_click`,{ruleSet:e,hadContent:r});ze(),vt(),i()})}var hn=!1;function gn(){let e=new Date,t=e=>String(e).padStart(2,`0`);return`${e.getFullYear()}${t(e.getMonth()+1)}${t(e.getDate())}-${t(e.getHours())}${t(e.getMinutes())}${t(e.getSeconds())}`}function B(e){let t=document.createElement(`div`);return t.textContent=e,t.innerHTML}function _n(){hn=!1;let e=document.createElement(`div`);e.className=`export-progress-overlay`,e.id=`export-progress-overlay`,e.innerHTML=`
  ...
  `,document.body.appendChild(e),document.getElementById(`btn-cancel-export`)?.addEventListener(`click`,()=>{hn=!0})}function vn(e,t){let n=Math.round(e/t*100),r=document.getElementById(`export-progress-bar`);r&&(r.style.width=`${n}%`);let i=document.getElementById(`export-progress-text`);i&&(i.textContent=`${e} / ${t}`)}function yn(){document.getElementById(`export-progress-overlay`)?.remove()}async function bn(e,t){let n=new Map;for(let r=0;r<e.length&&!hn;r++){try{let t=await E.getRuleInfo(e[r].identifier);n.set(e[r].identifier,t)}catch(t){console.warn(`Failed to fetch rule: ${e[r].identifier}`,t)}t(r+1,e.length)}return n}function xn(){return`
    :root {
  ...
  `}function Sn(e,t){let n=new Date().toLocaleDateString(`te-IN`,{year:`numeric`,month:`long`,day:`numeric`});return`
  ...
  `}var wn={Akkara:`అక్కరలు`,Divpada:`ద్విపదలు`,Jati:`జాతి`,Ragada:`రగడలు`,Ragada2:`రగడలు`,Shatpada:`షట్పదలు`,UpaJati:`ఉపజాతి`,Sisamu:`సీసములు`,Vruttam:`వృత్తం`,DaMDakamu:`దండకము`,ArdhaVruttam:`అర్ధ సమవృత్తం`,VishamaVruttam:`విషమవృత్తం`,GenricVruttam:`ఏదేని సమ వృత్తం`};function Tn(e){let t=e.shortName&&e.shortName!==e.name?e.shortName:e.name,n=e.alias?`<div class="rule-alias">${B(e.alias)}</div>`:``,r=[];if(e.padyamSubType){let t=wn[e.padyamSubType]||e.padyamSubType;r.push(`<span class="badge badge-type">${B(t)}</span>`)}if(e.min&&e.max&&e.min!==-1&&e.max!==-1){let t=e.min===e.max?`${e.min} ${w(`metric_chars`)}`:`${e.min}-${e.max} ${w(`metric_chars`)}`;r.push(`<span class="badge badge-chars">${t}</span>`)}else e.charLength&&e.charLength!==-1&&r.push(`<span class="badge badge-chars">${e.charLength} ${w(`metric_chars`)}</span>`);if(e.matraLength&&e.matraLength!==-1&&r.push(`<span class="badge badge-matras">${e.matraLength} ${w(`metric_matras`)}</span>`),e.lines&&e.lines>0){let t=e.lines===1?w(`pada_singular`):w(`pada_plural`);r.push(`<span class="badge badge-lines">${e.lines} ${t}</span>`)}e.chandamName&&r.push(`<span class="badge badge-chandam">${B(e.chandamName)}</span>`);let i=r.length>0?`<div class="rule-badges">${r.join(``)}</div>`:``,a=e.sequence?`<div class="rule-sequence"><code>${B(e.sequence)}</code></div>`:``,o=e.description?`<div class="description-content">${e.description}</div>`:``,s=En(e.examples);return`
  ...
  `}function En(e){if(!e||e.length===0)return``;let t=e.map(e=>`
  ...
  `}function Dn(e,t,n,r){let i;if(r){let n=t.values().next().value;i=`
      ${Sn(e+` — `+n.name,1)}
      ${Tn(n)}
    `}else{let r=ge(n),a=_e(r),o=Cn(r,a,t),s=a.map(e=>{let n=r.get(e),i=ye(e,r),a=n.map(e=>{let n=t.get(e.identifier);return n?Tn(n):``}).join(``);return`
...
<body>
  ...
  <div class="footer">${w(`export_book_generated`)} &middot; ${new Date().toISOString().split(`T`)[0]}</div>
...
</html>`}function On(e,t){let n=new Blob([e],{type:`text/html;charset=utf-8`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=t,i.style.display=`none`,i.setAttribute(`data-export`,`true`),document.body.appendChild(i),i.click(),setTimeout(()=>{document.body.removeChild(i),URL.revokeObjectURL(r)},100)}async function kn(e,n,r){t.startTimedEvent(`export_book_started`,{ruleSetId:n,ruleCount:r.length,type:`full`})(),_n();let i=t.startTimedEvent(`export_book_completed`,{ruleSetId:n,type:`full`});try{let a=await bn(r,vn);if(hn){t.startTimedEvent(`export_book_cancelled`,{ruleSetId:n,ruleCount:r.length})();return}let o=Dn(e,a,r,!1);On(o,`${n}-${gn()}.html`),i({ruleCount:a.size,fileSizeKB:Math.round(o.length/1024)})}catch(e){console.error(`Export failed:`,e),t.startTimedEvent(`export_book_error`,{ruleSetId:n,error:String(e)})()}finally{yn()}}async function An(e,n){t.startTimedEvent(`export_book_started`,{ruleId:n.identifier,type:`single`})();let r=t.startTimedEvent(`export_book_completed`,{ruleId:n.identifier,type:`single`}),i=new Map;i.set(n.identifier,n);let a=Dn(e,i,[],!0);On(a,`${n.identifier}-${gn()}.html`),r({fileSizeKB:Math.round(a.length/1024)})}var V={searchText:``,selectedCategory:``,selectedChandamName:``,hasExamples:!1},H=null,jn=0,Mn=[],Nn=``,Pn=``;async function Fn(e){let t=document.getElementById(`content`);t&&(t.innerHTML=`<div class="page-loading">
      <svg class="loader-svg" viewBox="0 0 128 48" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <circle class="loader-circle" cx="24" cy="24" r="7" fill="#1a3a5c"/>
        <circle class="loader-circle" cx="48" cy="24" r="10" fill="#b8860b"/>
        <circle class="loader-circle" cx="72" cy="24" r="7" fill="#1a3a5c"/>
    ...
    </div>`);let n=await m(e);if(!n){console.error(`Rule set not found: ${e}`);return}if(s(`Learn `+n.name),n.rulesFile)await $t(n.rulesFile,n.examplesFile);else if(!await F.loadCustomRuleset(e)){let e=document.getElementById(`content`);e&&(e.innerHTML=`
          <div class="empty-state">
            <p>${w(`filter_no_results`)}</p>
          </div>
        `);return}let r=(await E.getAllRulesDetailed(`te`)).filter(e=>e.padyamSubType!==`GenricVruttam`);jn=r.length,Mn=r,Nn=n.name,Pn=e,H=await E.getAvailableFilters(`te`);let i=await j.getAllFavorites(),a=new Set(e===`custom-fav`?i.map(e=>`custom-fav:${e.ruleId}`):i.filter(t=>t.ruleSetId===e).map(e=>e.id)),o=e===`custom-fav`?new Map(i.map(e=>[e.ruleId,e.ruleSetId])):void 0,c=await In(r),l=ge(c);Ln(n.name,c.length,e,l,a,o)}async function In(e){return V.searchText===``&&V.selectedCategory===``&&V.selectedChandamName===``&&!V.hasExamples?e:await E.searchRules({query:V.searchText||void 0,categories:V.selectedCategory?[V.selectedCategory]:void 0,chandamNames:V.selectedChandamName?[V.selectedChandamName]:void 0,hasExamples:V.hasExamples?!0:void 0,maxResults:0},`te`)}function Ln(e,t,n,r,i,a){let o=document.getElementById(`content`);if(!o)return;let s=se(n,`learn`,e),c=t>0?`<div class="chandam-groups">${Rn(r,n,i,a)}</div>`:`<div class="empty-state">
         <p>${w(`filter_no_results`)}</p>
    ...
    <div class="learn-index-page">
      ...
      <div class="page-header-controls">
        ...
        ${A({ruleSetId:n,currentMode:`learn`})}
      </div>
      <div class="filter-bar">
        <div class="filter-bar-row">
          ...
          <div class="filter-actions">
            <span class="filter-result-count">${t===jn?`${jn}`:`${w(`filter_results`)} (${t}/${jn})`}</span>
  ...
  `}function Hn(){return!H||!H.hasRulesWithExamples||!H.hasRulesWithoutExamples?``:`
  ...
  `}function Un(e){let n=document.querySelector(`.filter-search`);if(n){let r=V.searchText;async function i(){let i=n.value;if(i===r)return;r=i,V.searchText=i;let a=t.startTimedEvent(`filter_search`,{ruleSet:e,queryLength:i.length});await Wn(e),a()}n.addEventListener(`keydown`,async e=>{e.key!==`Enter`||e.isComposing||(e.preventDefault(),await i())}),n.addEventListener(`blur`,async()=>{await i()}),n.addEventListener(`search`,async()=>{await i()})}let r=document.getElementById(`category-picker`);r&&(r.querySelectorAll(`.rule-item`).forEach(n=>{n.addEventListener(`click`,async()=>{let i=n,a=i.dataset.filterType||`category`,o=i.dataset.value||``,s=document.querySelector(`.filter-search`);s&&(V.searchText=s.value),a===`chandam`?(V.selectedChandamName=o,V.selectedCategory=``):(V.selectedCategory=o,V.selectedChandamName=``);let c=document.getElementById(`selected-category-name`);c&&(c.textContent=Bn()+` ▼`),r.open=!1;let l=t.startTimedEvent(`filter_category`,{ruleSet:e,filterType:a,value:o||`all`});await Wn(e),l()})}),document.addEventListener(`click`,e=>{r.open&&!r.contains(e.target)&&(r.open=!1)}));let i=document.getElementById(`filter-has-examples`);i&&i.addEventListener(`change`,async()=>{let n=document.querySelector(`.filter-search`);n&&(V.searchText=n.value),V.hasExamples=i.checked;let r=t.startTimedEvent(`filter_examples`,{ruleSet:e,enabled:String(i.checked)});await Wn(e),r()});let a=document.querySelector(`[data-action="clear-filters"]`);a&&a.addEventListener(`click`,async()=>{V={searchText:``,selectedCategory:``,selectedChandamName:``,hasExamples:!1};let n=t.startTimedEvent(`filter_clear`,{ruleSet:e});await Wn(e),n()});let o=document.querySelector(`[data-action="export-book"]`);o&&o.addEventListener(`click`,async()=>{await kn(Nn,Pn,Mn)});let s=document.querySelector(`.rules-content`);s&&s.addEventListener(`click`,async e=>{let t=e.target.closest(`[data-action="delete-rule"]`);t&&await Gn(t.dataset.ruleId||``,t.dataset.ruleName||``)})}async function Wn(e){await Fn(e)}async function Gn(e,n){if(!await It(w(`alert_delete_confirm`),{title:`${w(`action_delete_custom_rule`)}: ${n}`,cancelText:w(`creator_btn_cancel`),confirmText:w(`action_delete_custom_rule`)}))return;let r=t.startTimedEvent(`custom_rule_deleted`,{ruleId:e,source:`index_page`});try{if(await P.deleteCustomRule(e),await j.isFavorited(`custom-rules`,e)){let t=await E.getRuleDto(e);await j.toggleFavorite(`custom-rules`,e,t)}r(),window.location.reload()}catch(e){console.error(`Failed to delete rule:`,e),N(w(`alert_delete_failed`),`error`)}}async function Kn(e,t){let n=await m(e);if(!n){console.error(`Rule set not found: ${e}`);return}n.rulesFile?await $t(n.rulesFile,n.examplesFile):await F.loadCustomRuleset(e);let r=await E.getRuleInfo(t);s(`Learn `+r.name,n.name),qn(e,r,n.name)}function qn(e,t,n){let r=document.getElementById(`content`);if(!r)return;let i=ce(e,t.identifier,t.name,`learn`,n),a=t.examples&&t.examples.length>0,o=!a&&t.padyamType===`Vruttam`,s=a?t.examples.length:o?1:0;r.innerHTML=`
    <div class="learn-detail-page">
      ...
      <div class="page-header-controls">
        ...
        ${A({ruleSetId:e,ruleId:t.identifier,currentMode:`learn`})}
      </div>
      ...
      <section class="examples">
        ...
        ${Yn(t.examples,e,t.identifier,o)}
      </section>

      ${Zn(t.references)}
    </div>
  `,Lt(`rule-actions-container`,e,t.identifier),document.getElementById(`btn-export-rule`)?.addEventListener(`click`,()=>{An(e,t)}),o&&(Jn(t.identifier),document.getElementById(`btn-regenerate`)?.addEventListener(`click`,()=>{Jn(t.identifier)}))}async function Jn(e){let t=document.getElementById(`generated-poem-text`);t&&(t.textContent=`...`,t.textContent=(await E.getRandomPoem(e)).text||`—`)}function Yn(e,t,n,r){return!e||e.length===0?r?Xn(t,n):`
    ...
    `}).join(``)}function Xn(e,t){let n=w(`generated_example_badge`),r=w(`generated_disclaimer`);return`
    <div class="example-card">
  ...
  `}function Zn(e){return!e||e.length===0?``:`
  ...
  `}function U(e){let t=document.createElement(`div`);return t.textContent=e,t.innerHTML}var Qn=/^[\w\s\u0C00-\u0C7F\u0C80-\u0CFF\u0900-\u097F-]+$/,W={PATTERN_ROW:`.pattern-row-inline`,ADD_GANA_BTN:`.add-gana-btn`,REMOVE_GANA_BTN:`.remove-gana-btn`,REMOVE_ROW_BTN:`.remove-row-btn`},G={RULE_NAME:`rule-name`,PADYAM_TYPE:`padyam-type`,GANA_TYPE:`gana-type`,SAME_RULES:`same-rules`,LINES:`lines`,ADD_PADA_BTN:`add-pada-btn`,REMOVE_PADA_BTN:`remove-pada-btn`,PATTERN_ROWS_CONTAINER:`pattern-rows-container`,PRASA:`prasa`,PRASA_YATI:`prasa-yati`,ANTHYA_PRASA:`anthya-prasa`};function $n(e){return!e||!e.trim()?[]:e.split(`,`).map(e=>parseInt(e.trim(),10)).filter(e=>!isNaN(e)&&e>0)}function er(e){let t=[];return e.forEach((e,n)=>{let r=n+1,i=document.getElementById(`yati-${r}`);if(i?.value.trim()){let e=$n(i.value);e.length>0&&t.push(e)}}),t}function tr(e){let t=e.trim().toLowerCase(),n=5381;for(let e=0;e<t.length;e++)n=(n<<5)+n+t.charCodeAt(e);return`custom-${Math.abs(n)&2147483647}`}async function nr(e){let t=[];return!e.Name||e.Name.trim()===``?t.push(w(`creator_validation_name`)):(e.Name.length>100&&t.push(w(`creator_validation_name_length`).replace(`{max}`,`100`)),Qn.test(e.Name)||t.push(w(`creator_validation_name_invalid`)),await P.ruleExists(e.Identifier)&&t.push(w(`creator_validation_name_exists`))),(!e.Rules||e.Rules.length===0||e.Rules[0].length===0)&&t.push(w(`creator_validation_ganas`)),e.Lines<1&&t.push(w(`creator_validation_lines_min`)),{isValid:t.length===0,errors:t}}function K(e){return document.getElementById(e)}function q(e){let t=document.getElementById(e);if(!t)throw Error(`Required element #${e} not found`);return t}var rr=new class{constructor(){this.rowCounter=0}incrementRow(){return++this.rowCounter}reset(){this.rowCounter=0}getCurrentCount(){return this.rowCounter}};async function ir(){s(`Create Rule`);let e=document.getElementById(`content`);e&&(e.innerHTML=ar(),or(),sr())}function ar(){return`
  ...
  `}function or(){rr.reset();let e=K(G.LINES);if(e)for(let t=1;t<=8;t++){let n=document.createElement(`option`);n.value=t.toString(),n.textContent=`${t} ${w(t===1?`pada_singular`:`pada_plural`)}`,t===4&&(n.selected=!0),e.appendChild(n)}let t=K(G.SAME_RULES);t&&(t.checked=!0),ur(`Vruttam`),pr(),dr(!0)}function sr(){K(G.PADYAM_TYPE)?.addEventListener(`change`,e=>{let t=e.target.value;ur(t),fr()}),K(G.GANA_TYPE)?.addEventListener(`change`,()=>{fr()}),K(G.SAME_RULES)?.addEventListener(`change`,e=>{let t=e.target.checked;dr(t)}),K(G.ADD_PADA_BTN)?.addEventListener(`click`,()=>pr()),K(G.REMOVE_PADA_BTN)?.addEventListener(`click`,()=>cr()),K(`cancel-btn`)?.addEventListener(`click`,()=>window.location.href=v(`/`)),K(`create-rule-btn`)?.addEventListener(`click`,async()=>await yr()),lr()}function cr(){let e=K(G.PATTERN_ROWS_CONTAINER)?.querySelectorAll(W.PATTERN_ROW);e&&e.length>1&&e[e.length-1].remove()}function lr(){K(G.PATTERN_ROWS_CONTAINER)?.addEventListener(`click`,e=>{let t=e.target;if(t.classList.contains(`add-gana-btn`)||t.closest(`.add-gana-btn`)){let e=t.closest(`.add-gana-btn`),n=parseInt(e?.getAttribute(`data-row`)||`0`);n>0&&(hr(n),_r(n))}else if(t.classList.contains(`remove-gana-btn`)||t.closest(`.remove-gana-btn`)){let e=t.closest(`.remove-gana-btn`),n=parseInt(e?.getAttribute(`data-row`)||`0`);n>0&&(gr(n),_r(n))}else if(t.classList.contains(`remove-row-btn`)||t.closest(`.remove-row-btn`)){let e=t.closest(`.remove-row-btn`),n=parseInt(e?.getAttribute(`data-row`)||`0`);n>0&&mr(n)}})}function ur(e){let t=K(G.GANA_TYPE);if(t){if(t.innerHTML=``,e===`Vruttam`){let e=document.createElement(`option`);e.value=`Name`,e.textContent=w(`gana_type_name`),t.appendChild(e)}else if(e===`Jati`){let e=document.createElement(`option`);e.value=`Type`,e.textContent=w(`gana_type_type`),t.appendChild(e);let n=document.createElement(`option`);n.value=`Weight`,n.textContent=w(`gana_type_weight`),t.appendChild(n)}else if(e===`UpaJati`){let e=document.createElement(`option`);e.value=`Type`,e.textContent=w(`gana_type_type`),t.appendChild(e)}}}function dr(e){let t=K(G.ADD_PADA_BTN),n=K(G.REMOVE_PADA_BTN);e?(t&&(t.disabled=!0,t.classList.add(`disabled`)),n&&(n.disabled=!0,n.classList.add(`disabled`)),document.querySelectorAll(W.REMOVE_ROW_BTN).forEach(e=>{e.style.display=`none`})):(t&&(t.disabled=!1,t.classList.remove(`disabled`)),n&&(n.disabled=!1,n.classList.remove(`disabled`)),document.querySelectorAll(W.REMOVE_ROW_BTN).forEach(e=>{e.style.display=`inline-block`}))}function fr(){let e=K(G.PATTERN_ROWS_CONTAINER);e&&e.querySelectorAll(W.PATTERN_ROW).forEach((e,t)=>{let n=t+1,r=document.getElementById(`gana-container-${n}`);if(r){let e=r.querySelectorAll(`select`).length;r.innerHTML=``;for(let t=0;t<e;t++)hr(n)}})}function pr(){let e=K(G.PATTERN_ROWS_CONTAINER);if(!e)return;let t=rr.incrementRow(),n=document.createElement(`div`);n.id=`row-${t}`,n.className=`pattern-row-inline`,n.innerHTML=`
  ...
  `;let i=document.getElementById(`graph-container`);i&&await wr({container:i,data:Sr(n,t.name),maxNodes:n.length>500?300:void 0,onNodeClick:t=>{t.ruleId&&(window.location.href=v(`/learn/${e}/${t.ruleId}`))}})}var Er=null,J=[];async function Dr(){s(w(`nav_my_writings`));let e=document.getElementById(`content`);e&&(J=await O.getAllPoems(),e.innerHTML=Or(J),Ar(e),t.trackEvent(`page_view`,{page:`my_writings`,poemCount:J.length}))}function Or(e){let t=e.length;if(t===0)return`
    ...
    `;let n=e.sort((e,t)=>t.addedAt-e.addedAt).map(e=>kr(e)).join(``);return`
    <div class="my-writings-page">
      <h1>${w(`nav_my_writings`)}</h1>
  ...
  `}function kr(e){let t=e.beautified?`<div class="poem">${at(e.beautified)}</div>`:`<pre class="poem-text">${jr(e.poemText)}</pre>`,n=v(`/compute/${e.ruleSetId}/${e.ruleIdentifier}`);return`
    <div class="writing-card" data-hash="${e.poemHash}">
      <div class="writing-header">
        <span class="meter-name">${jr(e.ruleName)}</span>
  ...
  `}function Ar(e){Er&&Er.abort(),Er=new AbortController,e.addEventListener(`click`,async n=>{let r=n.target,i=r.closest(`.btn-delete-writing`);if(i){let n=i.getAttribute(`data-hash`);if(!n||!await It(w(`writings_delete_confirm`),{title:w(`writings_delete`),cancelText:w(`creator_btn_cancel`),confirmText:w(`writings_delete`)}))return;await O.removePoem(n),t.trackEvent(`poem_removed`,{poemHash:n}),J=await O.getAllPoems(),e.innerHTML=Or(J),Ar(e);return}let a=r.closest(`.try-example-btn`);if(a){let e=a.getAttribute(`data-hash`);if(e){let t=J.find(t=>t.poemHash===e);t&&D.saveEditorState({text:t.poemText})}}},{signal:Er.signal})}function jr(e){let t=document.createElement(`div`);return t.textContent=e,t.innerHTML}async function Mr(){s(w(`my_data_title`));let e=document.getElementById(`content`);if(!e)return;let[n,r]=await Promise.all([O.getPoemCount(),P.getAllCustomRulesets()]),i=r.find(e=>e.type===`favorites`&&e.rules.length>0),a=r.find(e=>e.id===`custom-rules`&&e.rules.length>0),o=le(w(`my_data_title`)),c=[];if(n>0&&c.push(`
  ...
  `,document.getElementById(`btn-clear-all-data`)?.addEventListener(`click`,async()=>{await It(w(`clear_data_warning`),{title:w(`my_data_clear_btn`),cancelText:w(`creator_btn_cancel`),confirmText:w(`my_data_clear_btn`)})&&(await D.clearAll(),t.trackEvent(`clear_all_data`,{}),window.location.reload())}),t.trackEvent(`page_view`,{page:`my_data`})}var Nr={link:`link`,"play-circle":`play_circle`,book:`menu_book`,dictionary:`grid_view`,wrench:`build`,people:`group`,microscope:`science`,help:`help`,library:`local_library`,video:`smart_display`,code:`code`,play:`play_arrow`,delete:`delete`,add:`add`,bookmark:`bookmark`,download:`download`,refresh:`refresh`,random:`casino`,clear:`delete_sweep`,edit:`edit`,favorite:`favorite`};function Pr(e,t=16){return`<span class="material-symbols-outlined" style="font-size:${t}px" aria-hidden="true">${Nr[e]||Nr.link}</span>`}function Fr(e){return{link:`link`,youtube:`play-circle`,book:`book`,dictionary:`dictionary`,tool:`wrench`,community:`people`,research:`microscope`}[e]||`link`}function Ir(e){if(!e)return null;try{let t=e.match(/youtu\.be\/([a-zA-Z0-9_-]{11})/);return t||(t=e.match(/youtube\.com\/watch\?.*v=([a-zA-Z0-9_-]{11})/),t)||(t=e.match(/youtube\.com\/playlist\?.*list=([a-zA-Z0-9_-]+)/),t)?t[1]:null}catch{return null}}function Lr(e){return`https://img.youtube.com/vi/${e}/maxresdefault.jpg`}function Rr(e){return e?/youtube\.com|youtu\.be/.test(e):!1}function zr(){let e=window.location.pathname;return e.includes(`/pages/te/`)?`te`:e.includes(`/pages/en/`)?`en`:C()}async function Br(){let e=v(`/pages/${zr()}/resources.json`);try{let t=await fetch(e);if(!t.ok)throw Error(`Failed to load resources: ${t.status}`);Vr((await t.json()).groups)}catch(e){console.error(`Error loading resources page:`,e)}}function Vr(e){let t=document.getElementById(`resources-nav`);t&&(t.innerHTML=e.map(e=>`<a href="${v(`/resources`)+`#${e.id}`}">${e.title}</a>`).join(``));let n=document.getElementById(`resources-content`);n&&(n.innerHTML=e.map(e=>Hr(e)).join(``))}function Hr(e){let t=Pr(e.groupIcon,20),n=e.items.map(e=>Ur(e)).join(``);return`
  ...
  `}function Ur(e){return e.type===`youtube`&&e.link&&Rr(e.link)?qr(e):Wr(e)}function Wr(e){let t=Pr(Fr(e.type),16),n=e.link?Gr(e.link):null,r=n?Kr(n):``;return`
  ...
  `}function Gr(e){return e.startsWith(`/`)?v(e):e}function Kr(e){return` target="_blank" rel="noopener noreferrer"`}function qr(e){let t=Ir(e.link),n=Gr(e.link),r=Kr(n);if(!t)return Wr(e);let i=Lr(t),a=Pr(`play-circle`,48);return`
  ...
  `}async function Jr(e){return await m(e)!==void 0}async function Yr(e){try{return await E.getRuleInfo(e),!0}catch{return!1}}function Xr(e){console.warn(`Invalid rule set: ${e}, redirecting to home`),window.location.href=v(`/`)}function Zr(e,t){console.warn(`Invalid rule: ${t} in ${e}, redirecting to rule set page`),window.location.href=v(`/compute/${e}/`)}var Qr=`<svg class="loader-svg" viewBox="0 0 128 48" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  <circle class="loader-circle" cx="24" cy="24" r="7" fill="#1a3a5c"/>
  <circle class="loader-circle" cx="48" cy="24" r="10" fill="#b8860b"/>
  <circle class="loader-circle" cx="72" cy="24" r="7" fill="#1a3a5c"/>
  <circle class="loader-circle" cx="96" cy="24" r="10" fill="#b8860b"/>
</svg>`,$r=class{constructor(e){this.isShowing=!1,this.config=e,this.setupEventListeners()}setupEventListeners(){L.onLoadingStarted(()=>{this.show()}),L.onLoadingCompleted(()=>{this.hide()}),L.onLoadingFailed(()=>{this.hide()})}show(){let e=document.getElementById(this.config.containerId);e&&(this.isShowing||=(e.innerHTML=this.createLoaderHTML(),!0))}async hide(){if(!this.isShowing)return;let e=document.getElementById(this.config.containerId);if(e){let t=e.querySelector(`.loader-container`);t&&(t.classList.add(`fade-out`),await this.delay(400),e.innerHTML=``)}this.isShowing=!1}createLoaderHTML(){return`
    ...
    `}delay(e){return new Promise(t=>setTimeout(t,e))}};function ei(){return new $r({fallbackText:`Loading Chandam...`,containerId:`initial-loader`})}var ti=`<div class="page-loading">
  <svg class="loader-svg" viewBox="0 0 128 48" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <circle class="loader-circle" cx="24" cy="24" r="7" fill="#1a3a5c"/>
    <circle class="loader-circle" cx="48" cy="24" r="10" fill="#b8860b"/>
    <circle class="loader-circle" cx="72" cy="24" r="7" fill="#1a3a5c"/>
...
</div>`,ni=class{constructor(){this.activeActions=new Map,this.setupEventListeners()}setupEventListeners(){L.onActionStarted(e=>this.handleStart(e)),L.onActionCompleted(e=>this.handleEnd(e)),L.onActionFailed(e=>this.handleEnd(e))}handleStart(e){let{source:t,buttonId:n,resultContainerId:r}=e;if(!n)return;let i=document.getElementById(n);if(i&&(i.classList.add(`is-loading`),i.setAttribute(`aria-busy`,`true`)),r){let e=document.getElementById(r);if(e){e.style.display=`block`;let t=e.querySelector(`#results-container`);t&&(t.innerHTML=ti)}}this.activeActions.set(t,{buttonId:n,resultContainerId:r})}handleEnd(e){let t=this.activeActions.get(e.source);if(!t)return;let n=document.getElementById(t.buttonId);n&&(n.classList.remove(`is-loading`),n.removeAttribute(`aria-busy`)),this.activeActions.delete(e.source)}};function ri(){return new ni}async function ii(e){try{console.log(`Decompression: Fetching ${e}`);let t=await fetch(e);if(!t.ok)throw Error(`HTTP error! status: ${t.status}`);let n=t.body;if(!n)throw Error(`Response body is null`);let r=n.pipeThrough(new DecompressionStream(`gzip`)).getReader(),i=[],a=0;for(;;){let{done:e,value:t}=await r.read();if(e)break;i.push(t),a+=t.length}let o=new Uint8Array(a),s=0;for(let e of i)o.set(e,s),s+=e.length;let c=new TextDecoder(`utf-8`).decode(o);return console.log(`Decompression: ${e} → ${c.length} chars (${a} bytes)`),c}catch(e){throw console.error(`Decompression failed:`,e),e}}typeof window<`u`&&(window.decompressGzip=ii);var ai=S.USER_ID;function oi(){let e=localStorage.getItem(ai);return e||(e=crypto.randomUUID(),localStorage.setItem(ai,e),console.log(`[Analytics] Generated new user ID:`,e.substring(0,8)+`...`)),e}function si(){window.chandam={storage:{getEditor:()=>D.loadEditorState(),getUI:()=>D.loadUIState(),clear:()=>D.clearAll()},analytics:{getUserId:()=>{let e=oi();return console.log(`User ID:`,e),e},resetUserId:()=>{localStorage.removeItem(ai);let e=oi();return console.log(`New user ID generated:`,e),e}},favorites:{list:async()=>{let e=await j.getAllFavorites();return console.table(e.map(e=>({ruleSet:e.ruleSetId,rule:e.ruleId,name:e.ruleData.name,favorited:new Date(e.favoritedAt).toLocaleString()}))),e},add:async(e,t)=>{if(await j.isFavorited(e,t))return console.log(`Already favorited`),!1;let n=await E.getRuleDto(t);return await j.toggleFavorite(e,t,n),console.log(`Added ${t} to favorites`),!0},remove:async(e,t)=>{if(!await j.isFavorited(e,t))return console.log(`Not in favorites`),!1;let n=await E.getRuleDto(t);return await j.toggleFavorite(e,t,n),console.log(`Removed ${t} from favorites`),!0},check:async(e,t)=>{let n=await j.isFavorited(e,t);return console.log(n?`Favorited`:`Not favorited`),n},count:async()=>{let e=await j.getFavoriteCount();return console.log(`${e} favorites (max 50)`),e},clear:async()=>{let e=await j.getAllFavorites();for(let t of e)await j.toggleFavorite(t.ruleSetId,t.ruleId,t.ruleData);return console.log(`All favorites cleared`),!0}},custom:{list:async()=>{let e=await P.getAllCustomRulesets();return console.table(e.map(e=>({id:e.id,name:e.name,type:e.type,rules:e.rules.length,updated:new Date(e.updatedAt).toLocaleString()}))),e},get:async e=>await P.getCustomRuleset(e),set:async(e,t,n)=>{try{let r=JSON.parse(n);if(!Array.isArray(r))return console.error(`Rules must be an array`),!1;if(r.length>20)return console.error(`Cannot exceed 20 rules per custom ruleset`),!1;if(e===`custom-fav`)return console.error(`Cannot manually edit favorites collection. Use chandam.favorites API.`),!1;let i={id:e,name:t,description:`User-defined rules (${r.length} rules)`,rules:r,type:`custom`,createdAt:Date.now(),updatedAt:Date.now()};await D.init();let a=await P.getAllCustomRulesets(),o=a.findIndex(t=>t.id===e);return o>=0?a[o]=i:a.push(i),await D.indexedDB.saveData(`custom-rulesets`,a),console.log(`Saved custom ruleset "${t}" with ${r.length} rules`),await F.loadCustomRuleset(i.id),console.log(`Custom ruleset loaded into WASM engine`),!0}catch(e){return console.error(`Invalid JSON:`,e),!1}},delete:async e=>{if(e===`custom-fav`)return console.error(`Cannot delete favorites collection. Use chandam.favorites.clear() instead.`),!1;await D.init();let t=(await P.getAllCustomRulesets()).filter(t=>t.id!==e);return await D.indexedDB.saveData(`custom-rulesets`,t),console.log(`Custom ruleset "${e}" deleted`),!0}}},console.log(`Chandam console API loaded. Try:`),console.log(`  chandam.favorites.list()`),console.log(`  chandam.custom.list()`)}var ci={te:{baseCodePoint:3072,halantOffset:77,overrides:{}},kn:{baseCodePoint:3200,halantOffset:77,overrides:{}},de:{baseCodePoint:2304,halantOffset:77,overrides:{}}},li={2:[5,62],3:[6,62],4:[7,63],5:[8,64],6:[9,65],7:[10,66],8:[11,67],9:[96,68],10:[12,98],11:[97,99],13:[14,70],14:[15,71],15:[16,72],17:[18,74],18:[19,75],19:[20,76]},ui={101:21,102:22,103:23,104:24,105:25,106:26,107:27,108:28,109:29,110:30,111:31,112:32,113:33,114:34,115:35,116:36,117:37,118:38,119:39,120:40,122:42,123:43,124:44,125:45,126:46,127:47,128:48,129:49,130:50,131:51,133:53,134:54,135:55,136:56,137:57},di={200:1,201:1,202:2,203:3,204:61},fi={hash:{a:2,"a'":3,A:3,aa:3,i:4,"i'":5,I:5,ee:5,ii:5,u:6,"u'":7,U:7,uu:7,oo:7,R:8,Ru:9,"~l":10,"~L":11,e:13,"e'":14,E:14,ea:14,ai:15,o:17,"o'":18,O:18,oa:18,au:19,ou:19,"@M":201,"@m":201,M:202,"@h":203,"@2":204,k:101,kh:102,K:102,g:103,gh:104,G:104,"~m":105,ch:106,c:106,Ch:107,C:107,j:108,jh:109,J:109,"~n":110,T:111,Th:112,D:113,Dh:114,N:115,t:116,th:117,d:118,dh:119,n:120,p:122,ph:123,f:123,P:123,b:124,bh:125,B:125,m:126,y:127,r:128,"~r":129,l:130,L:131,v:133,w:133,S:134,sh:135,s:136,h:137,nk:[202,101],nkh:[202,102],nK:[202,102],ng:[202,103],ngh:[202,104],nG:[202,104],nc:[202,106],nch:[202,106],nCh:[202,107],nC:[202,107],nj:[202,108],njh:[202,109],nJ:[202,109],nT:[202,111],nTh:[202,112],nD:[202,113],nDh:[202,114],nt:[202,116],nth:[202,117],nd:[202,118],ndh:[202,119],np:[202,122],nph:[202,123],nf:[202,123],nP:[202,123],nb:[202,124],nbh:[202,125],nB:[202,125],nS:[202,134],nsh:[202,135],ns:[202,136],mk:[202,101],mkh:[202,102],mK:[202,102],mg:[202,103],mgh:[202,104],mG:[202,104],mc:[202,106],mch:[202,106],mCh:[202,107],mC:[202,107],mj:[202,108],mjh:[202,109],mJ:[202,109],mT:[202,111],mTh:[202,112],mD:[202,113],mDh:[202,114],mt:[202,116],mth:[202,117],md:[202,118],mdh:[202,119],mp:[202,122],mph:[202,123],mf:[202,123],mP:[202,123],mb:[202,124],mbh:[202,125],mB:[202,125],mS:[202,134],msh:[202,135],ms:[202,136],mv:[202,133],mw:[202,133],x:[101,135],"#":255,"^":254,"&":253,_:252},array:`.@M.M.@h..a.A.i.I.u.U.R.~l..e.E.ai..o.O.au.k.kh.g.gh.~m.ch.Ch.j.jh.~n.T.Th.D.Dh.N.t.th.d.dh.n..p.ph.b.bh.m.y.r.~r.l.L..v.S.sh.s.h`.split(`.`)};function pi(e){switch(e){case`rts`:return fi;default:return fi}}function Y(e){return String.fromCharCode(e)}function mi(e,t,n){let r=pi(t),i=ci[n],a=i.baseCodePoint,o=a+i.halantOffset,s=r.hash,c=``,l=!1,u=0,d=e.length;for(;u<d;){let t=!1;for(let n=3;n>0;n--){if(u+n>d)continue;let r=s[e.substring(u,u+n)];if(r!==void 0){if(Array.isArray(r))for(let e of r)c+=_i(e,a,o,l),l=hi(e);else c+=_i(r,a,o,l),l=hi(r);u+=n,t=!0;break}}t||(l&&=(c+=Y(o),!1),c+=e[u],u++)}return l&&(c+=Y(o)),c}function hi(e){return e>=101&&e<=147}function gi(e){return e>=2&&e<=19}function _i(e,t,n,r){if(e>=200&&e<=205){let n=di[e];if(n===void 0)return``;let r=``;return r+=Y(t+n),r}if(gi(e)){let n=li[e];return n?r?e===2?``:Y(t+n[1]):Y(t+n[0]):``}if(hi(e)){let i=ui[e];if(i===void 0)return``;let a=``;return r&&(a+=Y(n)),a+=Y(t+i),a}return e===252?``:(e===253||e===254)&&r?Y(n):``}var vi=new Set([`ArrowLeft`,`ArrowRight`,`ArrowUp`,`ArrowDown`,`Home`,`End`,`PageUp`,`PageDown`,`Escape`,`Tab`]),yi=new Set([` `,`.`,`,`,`;`,`:`,`!`,`?`,`
`,`\r`,`(`,`)`,`[`,`]`,`{`,`}`,`"`,`'`,`/`,`\\`,`|`,`-`]);function bi(e,t){let n={inputBuffer:``,prevOutputLen:0},r=!1;function i(i){let{scheme:a,script:o}=t();if(a!==`none`){if(i.inputType===`insertText`&&i.data&&i.data.length===1){let t=i.data;if(yi.has(t)){X(n);return}i.preventDefault(),r=!0,n.inputBuffer+=t,xi(e,n,a,o);return}if(i.inputType===`deleteContentBackward`){n.inputBuffer.length>0&&(i.preventDefault(),r=!0,n.inputBuffer=n.inputBuffer.slice(0,-1),xi(e,n,a,o));return}if(i.inputType===`insertLineBreak`||i.inputType===`insertParagraph`){X(n);return}}}function a(r){let{scheme:i}=t();if(i!==`none`){if(vi.has(r.key)){X(n);return}if(r.key===`Backspace`){if(n.inputBuffer.length>0){r.preventDefault(),n.inputBuffer=n.inputBuffer.slice(0,-1);let{script:a}=t();xi(e,n,i,a)}return}}}function o(i){if(r){r=!1;return}let{scheme:a,script:o}=t();if(a===`none`)return;if(i.ctrlKey||i.altKey||i.metaKey){X(n);return}let s=i.key;if(s.length===1){if(yi.has(s)){X(n);return}if(i.key===`Enter`){X(n);return}i.preventDefault(),n.inputBuffer+=s,xi(e,n,a,o)}}function s(){X(n)}function c(){X(n)}return e.addEventListener(`beforeinput`,i),e.addEventListener(`keydown`,a),e.addEventListener(`keypress`,o),e.addEventListener(`mouseup`,s),e.addEventListener(`touchend`,c),()=>{e.removeEventListener(`beforeinput`,i),e.removeEventListener(`keydown`,a),e.removeEventListener(`keypress`,o),e.removeEventListener(`mouseup`,s),e.removeEventListener(`touchend`,c)}}function X(e){e.inputBuffer=``,e.prevOutputLen=0}function xi(e,t,n,r){let i=t.inputBuffer.length>0?mi(t.inputBuffer,n,r):``,a=e.selectionStart??e.value.length,o=a-t.prevOutputLen;e.value=e.value.substring(0,o)+i+e.value.substring(a);let s=o+i.length;e.setSelectionRange(s,s),t.prevOutputLen=i.length,e.dispatchEvent(new Event(`input`,{bubbles:!0}))}var Si=`chandam:kb-scheme`,Ci=`rts`,wi=`te`;function Ti(){try{let e=localStorage.getItem(Si);if(e){let[t,n]=e.split(`:`);if(Di(t)&&Oi(n))return{scheme:t,script:n}}}catch{}return{scheme:Ci,script:wi}}function Ei(e){try{localStorage.setItem(Si,`${e.scheme}:${e.script}`)}catch{}}function Di(e){return e===`rts`||e===`itx`||e===`iast`||e===`none`}function Oi(e){return e===`te`||e===`kn`||e===`de`}var Z,ki,Q=null,Ai=null;function ji(e){let t=Ti();Z=t.scheme,ki=t.script,Q=document.getElementById(`kb-toggle`),Q&&(Fi(),Q.addEventListener(`click`,Pi),Ai=e)}function Mi(){return Z}function Ni(){return ki}function Pi(){Z=Z===`none`?`rts`:`none`,Ei({scheme:Z,script:ki}),Fi(),Ai?.(Z,ki)}function Fi(){if(!Q)return;let e=Z!==`none`;Q.classList.toggle(`active`,e),Q.setAttribute(`aria-pressed`,String(e));let t=Q.querySelector(`rect`),n=Q.querySelector(`text`);t&&n&&(t.setAttribute(`fill`,e?`#1a3a5c`:`#999`),n.setAttribute(`fill`,e?`#f5f3f0`:`#ccc`))}var Ii=new Set,Li=new Map;function Ri(){ji((e,t)=>{}),document.addEventListener(`focusin`,e=>{let t=e.target;if(!zi(t)||Ii.has(t))return;let n=bi(t,()=>({scheme:Mi(),script:Ni()}));Ii.add(t),Li.set(t,n)}),document.addEventListener(`focusout`,e=>{let t=e.target;zi(t)&&setTimeout(()=>{if(document.activeElement!==t){let e=Li.get(t);e&&(e(),Li.delete(t),Ii.delete(t))}},200)})}function zi(e){if(!e||!(e instanceof HTMLElement))return!1;if(e instanceof HTMLTextAreaElement)return!0;if(e instanceof HTMLInputElement){let t=e.type.toLowerCase();return t===`text`||t===`search`||t===``}return!1}var $=new n;async function Bi(e){let t=await m(e);t&&(t.rulesFile||await F.loadCustomRuleset(e))}ei(),ri(),$.register(`/`,()=>{s(w(`nav_home`)),r(`pages/${C()}/home.html`)}),$.register(`/rule-sets`,()=>{de()}),$.register(`/create-rule`,async()=>{await ir()}),$.register(`/compute/:ruleSet/`,async e=>{if(!await Jr(e.ruleSet)){Xr(e.ruleSet);return}await nn(e.ruleSet)}),$.register(`/compute/:ruleSet/:ruleId`,async e=>{if(!await Jr(e.ruleSet)){Xr(e.ruleSet);return}if(await Bi(e.ruleSet),!await Yr(e.ruleId)){Zr(e.ruleSet,e.ruleId);return}await cn(e)}),$.register(`/explore/:ruleSet/`,async e=>{if(!await Jr(e.ruleSet)){Xr(e.ruleSet);return}await Tr(e.ruleSet)}),$.register(`/learn/:ruleSet/`,async e=>{if(!await Jr(e.ruleSet)){Xr(e.ruleSet);return}await Fn(e.ruleSet)}),$.register(`/learn/:ruleSet/:ruleId`,async e=>{if(!await Jr(e.ruleSet)){Xr(e.ruleSet);return}if(await Bi(e.ruleSet),!await Yr(e.ruleId)){Zr(e.ruleSet,e.ruleId);return}await Kn(e.ruleSet,e.ruleId)}),$.register(`/my-writings`,async()=>{await Dr()}),$.register(`/my-data`,async()=>{await Mr()}),$.register(`/resources`,async()=>{s(w(`nav_resources`)),await r(`pages/${C()}/resources.html`),Br()}),$.register(`/about`,()=>{s(w(`nav_about`)),r(`pages/${C()}/about.html`)}),$.register(`/credits`,()=>{s(w(`nav_credits`)),r(`pages/${C()}/credits.html`)}),$.register(`/contact`,()=>{s(w(`nav_contact`)),r(`pages/${C()}/contact.html`)});function Vi(){document.documentElement.lang=C(),document.querySelectorAll(`[data-i18n]`).forEach(e=>{let t=e.getAttribute(`data-i18n`);if(e.children.length>0){let n=Array.from(e.childNodes).filter(e=>e.nodeType===Node.TEXT_NODE&&e.textContent?.trim()),r=n[n.length-1];r&&(r.textContent=` ${w(t)}`)}else e.textContent=w(t)});let e=document.getElementById(`lang-toggle`);if(e){e.title=w(`lang_toggle_title`);let t=e.querySelector(`.lang-current`);t&&(t.textContent=w(`lang_name`))}}window.addEventListener(`languagechange`,()=>{Vi(),$.route()}),document.addEventListener(`DOMContentLoaded`,()=>{ie(),Vi(),Ri(),document.getElementById(`nav-toggle`)?.addEventListener(`click`,()=>{document.getElementById(`main-nav`)?.classList.toggle(`open`)}),document.getElementById(`lang-toggle`)?.addEventListener(`click`,()=>{let e=t.startTimedEvent(`language_toggle`,{});oe(),e({language:C()})})}),window.onWasmReady=async()=>{console.log(`WASM ready, initializing storage and console API...`),await D.init(),console.log(`Storage initialized`),si(),t.init(),t.setUserId(oi());try{let e=await E.getVersion(),t=await E.getBuildDate(),n=document.getElementById(`version-info`),r=document.getElementById(`build-date-info`);n&&(n.textContent=`v${e}`),r&&(r.textContent=`Published: ${t}`)}catch{}D.loadEditorState().text&&console.log(`Restored editor state from previous session`),L.emit(I.LoadingCompleted,{source:`wasm-init`,message:`WASM initialization complete`}),console.log(`Initializing router`),$.init()};var Hi=b,Ui=!1,Wi=setTimeout(()=>{if(!Ui){console.error(`[Chandam] WASM initialization timeout - check browser console`);let e=document.getElementById(`initial-loader`);e&&(e.innerHTML=`
      ...
      `),typeof window.gtag==`function`&&window.gtag(`event`,`exception`,{description:`wasm_init_timeout`,fatal:!0})}},Hi),Gi=window.onWasmReady;window.onWasmReady=async()=>{Ui=!0,clearTimeout(Wi),Gi&&await Gi()};export{t};